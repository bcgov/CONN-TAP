resource "aws_glue_catalog_table" "telus_spend" {
  ...
  storage_descriptor {
    location      = "s3://${var.ngta_raw_bucket}/processed/telus/spend_reports/"
...
resource "aws_glue_catalog_table" "rogers_spend" {
  ...
  storage_descriptor {
    location      = "s3://${var.ngta_raw_bucket}/processed/rogers/spend_reports/"
    input_format  = "org.apache.hadoop.hive.ql.io.parquet.MapredParquetInputFormat"
    output_format = "org.apache.hadoop.hive.ql.io.parquet.MapredParquetOutputFormat"
...
resource "aws_glue_catalog_table" "cellular_qsr" {
  name          = "cellular_qsr"
  database_name = "tsma_telecom_qsr"
  table_type    = "EXTERNAL_TABLE"
  ...
  storage_descriptor {
    location      = "s3://${var.tsma_raw_bucket}/processed_quarterly_spend_report/latest/wls/"
    input_format  = "org.apache.hadoop.hive.ql.io.parquet.MapredParquetInputFormat"
    output_format = "org.apache.hadoop.hive.ql.io.parquet.MapredParquetOutputFormat"
...
resource "aws_glue_catalog_table" "voice_qsr" {
  ...
  storage_descriptor {
    location      = "s3://${var.tsma_raw_bucket}/processed_quarterly_spend_report/latest/wln/"
    input_format  = "org.apache.hadoop.hive.ql.io.parquet.MapredParquetInputFormat"
    output_format = "org.apache.hadoop.hive.ql.io.parquet.MapredParquetOutputFormat"
