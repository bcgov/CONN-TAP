locals {
  ...
  # Per-env defaults: any branch may deploy via the matching GitHub Environment.
  # The 'environment:dev' subject lets you gate deploys on a GitHub Environment
  # (and its required reviewers / branch protections).
