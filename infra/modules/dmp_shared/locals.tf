locals {
  glue_scripts = {
    "load-ngta-rogers-pricebook-notebook" = {
      ...
      source   = "${var.assets_dir}/scripts/load-ngta-rogers-pricebook-notebook.py"
