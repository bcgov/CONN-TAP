...
data "archive_file" "lambda_ngta_rogers" {
  type        = "zip"
  output_path = "${var.assets_dir}/lambda/lambda-ngta-rogers.zip"
  source {
    content  = file("${var.assets_dir}/lambda/lambda-ngta-rogers.py")
...
data "archive_file" "lambda_ngta_telus" {
  type        = "zip"
  output_path = "${var.assets_dir}/lambda/lambda-ngta-telus.zip"
  source {
    content  = file("${var.assets_dir}/lambda/lambda-ngta-telus.py")
    filename = "lambda_function.py"
  }
}
...
data "archive_file" "lambda_ngta_telus_quantities" {
  type        = "zip"
  output_path = "${var.assets_dir}/lambda/lambda-ngta-telus-quantities.zip"
  source {
    content  = file("${var.assets_dir}/lambda/lambda-ngta-telus-quantities.py")
    filename = "lambda_function.py"
  }
}
...
data "archive_file" "lambda_tsma_fact" {
  type        = "zip"
  output_path = "${var.assets_dir}/lambda/lambda-tsma-fact.zip"
  source {
    content  = file("${var.assets_dir}/lambda/lambda-tsma-fact.py")
    filename = "lambda_function.py"
  }
}
...
data "archive_file" "lambda_tsma_qsr" {
  type        = "zip"
  output_path = "${var.assets_dir}/lambda/lambda-tsma-qsr.zip"
  source {
    content  = file("${var.assets_dir}/lambda/lambda-tsma-qsr.py")
    filename = "lambda_function.py"
  }
}
