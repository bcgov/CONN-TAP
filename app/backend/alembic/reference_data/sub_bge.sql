...
INSERT INTO reference_data.sub_bge (code, name, bge_id, entity_type, onboarded, cellular, data, voice) VALUES
    ('Agriculture and Food',                          'BC Min Agriculture & Food',                     (SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'sub_org', true, 'Self', 'CSBC', 'CSBC'),
    ('Attorney General',                              'BC Min Attorney General',                       (SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'sub_org', true, 'Self', 'CSBC', 'CSBC'),
    ('Children and Family Development',               'BC Min Children & Family Development',          (SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'sub_org', true, 'Self', 'CSBC', 'CSBC'),
    ('Citizens Services',                             'BC Min Citizens'' Services (CSBC)',             (SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'sub_org', true, 'CSBC', 'CSBC', 'CSBC'),
    ...
    ('Education and Child Care',                      'BC Min Education & Childcare',                  (SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'sub_org', true, 'Self', 'CSBC', 'CSBC'),
    ('Emergency Management and Climate Readiness',    'BC Min Emerg Mgmt & Climate Readiness',         (SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'sub_org', true, 'Self', 'CSBC', 'CSBC'),
    ('Energy and Climate Solutions',                  'BC Min Energy & Climate Solutions',             (SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'sub_org', true, 'Self', 'CSBC', 'CSBC'),
    ('Environment and Parks',                         'BC Min Environment and Parks',                  (SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'sub_org', true, 'Self', 'CSBC', 'CSBC'),
    ('Finance',                                       'BC Min Finance',                                (SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'sub_org', true, 'Self', 'CSBC', 'CSBC'),
    ('Forests',                                       'BC Min Forests',                                (SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'sub_org', true, 'Self', 'CSBC', 'CSBC'),
    ('Health',                                        'BC Min Health',                                 (SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'sub_org', true, 'Self', 'CSBC', 'CSBC'),
    ('Housing and Municipal Affairs',                 'BC Min Housing & Municipal Affairs',            (SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'sub_org', true, 'Self', 'CSBC', 'CSBC'),
    ('Indigenous Relations and Reconciliation',       'BC Min Indigenous Relations and Reconciliation',(SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'sub_org', true, 'Self', 'CSBC', 'CSBC'),
    ('Infrastructure',                                'BC Min Infrastructure',                         (SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'sub_org', true, 'Self', 'CSBC', 'CSBC'),
    ('Jobs Economic Development and Innovation',      'BC Min Jobs & Economic Growth',                 (SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'sub_org', true, 'Self', 'CSBC', 'CSBC'),
    ('Labour',                                        'BC Min Labour',                                 (SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'sub_org', true, 'Self', 'CSBC', 'CSBC'),
    ('Mining and Critical Minerals',                  'BC Min Mining & Critical Minerals',             (SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'sub_org', true, 'Self', 'CSBC', 'CSBC'),
    ('Post-Secondary Education and Future Skills',    'BC Min Post-Secondary Ed & Future Skills',      (SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'sub_org', true, 'Self', 'CSBC', 'CSBC'),
    ('Public Safety and Solicitor General',           'BC Min Public Safety & Solicitor Gen',          (SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'sub_org', true, 'Self', 'CSBC', 'CSBC'),
    ('Social Development and Poverty Reduction',      'BC Min Social Dev & Poverty Reduction',         (SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'sub_org', true, 'Self', 'CSBC', 'CSBC'),
    ('Tourism Arts Culture and Sport',                'BC Min Tourism, Arts, Culture, and Sport',      (SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'sub_org', true, 'Self', 'CSBC', 'CSBC'),
    ('Transportation and Transit',                    'BC Min Transportation & Transit',               (SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'sub_org', true, 'Self', 'CSBC', 'CSBC'),
    ('Water Land and Resource Stewardship',           'BC Min Water Land & Resource Steward',          (SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'sub_org', true, 'Self', 'CSBC', 'CSBC'),
    ('Office of the Premier',                         'BC Office of the Premier',                      (SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'sub_org', true, 'Self', 'CSBC', 'CSBC'),
...
INSERT INTO reference_data.sub_bge (code, name, bge_id, entity_type, parent_sub_bge_id, onboarded, cellular, data, voice) VALUES
    ...
    ('LEGISLATIVE ASSEMBLY',                                'BC Legislative Assembly',                             (SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'service_designee', (SELECT id FROM reference_data.sub_bge WHERE code = 'Citizens Services'), true,  'Self', 'Self', 'CSBC'),
    ...
    ('Superior Court Judiciary Branch',                     'Superior Court Judiciary Branch',                     (SELECT id FROM reference_data.bge WHERE code = 'Gov BC'), 'service_designee', (SELECT id FROM reference_data.sub_bge WHERE code = 'Citizens Services'), true,  'Self', 'n/a',  'n/a'),
    ...
    ('BC Emergency Health Services',                        'BC Emergency Health Services (BC Ambulance)',         (SELECT id FROM reference_data.bge WHERE code = 'PHSA'), 'sub_org', NULL, true,  'PHSA', 'PHSA', 'PHSA'),
    ...
    ('Vancouver General Hospital',                          'Vancouver General Hospital',                          (SELECT id FROM reference_data.bge WHERE code = 'VCHA (+PHC)'), 'sub_org', NULL, true,  'Self', 'PHSA', 'Self'),
    ('Powertech',                                           'Powertech Labs',                                 (SELECT id FROM reference_data.bge WHERE code = 'BC Hydro'), 'service_designee', NULL, true,  'Self', 'n/a',  'n/a'),
